  ...
  return (
    <div className="app__cake flex__center">
      <div className="app__cake-content">
        ...
        <h1 className="headtext__cormorant">Тортики ручной работы</h1>
        <p className="p__opensans" style={{ color: '#AAAAAA', marginTop: '2rem' }}>Делаем веганские торты на заказ. Без молочки и глютена. Посмотрите какая красота! Подробнее в меню. </p>
